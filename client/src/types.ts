...
export interface Goal {
  ...
  targetMonth?: string
  /**
   * תאריך מדויק (YYYY-MM-DD) כשהוא ידוע — חתונה, טיסה, מועד תשלום.
   * גובר על חודש היעד; החישוב החודשי נגזר מהחודש שלו.
   */
  targetDate?: string
  note?: string
  /** סומן כהושלם — עובר לארכיון ויוצא מחישוב ההפרשה החודשית */
  done?: boolean
}
